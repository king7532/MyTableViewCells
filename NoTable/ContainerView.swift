...
class ContainerView: UIView, UITextViewDelegate {
    ...
    override func awakeFromNib() {
        ...
        let heightConstraint = NSLayoutConstraint(item: self, attribute: .Height, relatedBy: .GreaterThanOrEqual, toItem: nil, attribute: .Height, multiplier: 1.0, constant: 44)
